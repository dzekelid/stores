...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/stores/master/_listings/atlassian/apis.md
...
- name: Jira Cloud REST API - Store avatar
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/stores/master/_listings/atlassian/api2universal-avatartypetypeownerentityid-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/stores/master/_listings/atlassian/api2universal-avatartypetypeownerentityid-post-openapi.md
- name: Jira Cloud REST API - Store avatar
  x-api-slug: api2universal-avatartypetypeownerentityid-post
  description: Creates an avatar for a given entity, for the given entity ID and type
    of entity. For example, you can create an avatar for an issue type, given the
