...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/stores/master/_listings/akamai/security-monitor-v1-report-packs-reportpackid-data-stores-get.md
x-common:
- type: x-base
